...
2.  Enter the Azure SQL Server name, select **SQL Server
    Authentication**, provide the **sqladminuser** credentials, dropdown
    the database name.

> ![A screenshot of a computer AI-generated content may be
> incorrect.](./media/image5.png)

3.  Sign in with your Microsoft work, school, or personal account, enter
    your credentials.
...
>
> ![A screen shot of a login box AI-generated content may be
...
5.  Select the **WideWorldImporters** database and click **Connect**.
...
15. Continue repeating steps **6 through 14** to upload all the
    remaining files.
...
1.  Click on the **Azure Portal Menu** and select **Create a resource**.
...
12. On **fabricstorageXX | Containers** page,
...
15. On the left navigation, click on ***Data Factory-MedallionXX***, as
...
5.  On the left navigation, click on ***Data Factory-MedallionXX***, as
    shown in the image below.
...
1.  On the left navigation, select ***Data Factory-MedallionXX***, as
    shown in the image below.
...
18. On the **Source** tab, select '**Append**' from the **Table action**
...
12. On the left navigation, select ***Data Factory-MedallionXX***, as
    shown in the image below.
