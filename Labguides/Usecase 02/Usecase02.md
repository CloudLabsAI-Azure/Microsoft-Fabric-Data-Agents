...
1.  From the left navigation select ***Data Factory-XX***, as shown in
    the image below.
...
6.  Click on the **Connect** button.![A screenshot of a computer
    AI-generated content may be incorrect.](./media/image36.png)
...
15. On the left navigation select ***Data Factory-XX***, as shown in the
    image below.
...
3.  On the left navigation, select ***Data Factory-XX***, as shown in
    the image below.
...
\[!note\] **Note:** Replace **Copy_data1** with the name of your own
...
\[!note\]**Note**: The example here schedules the pipeline to execute
...
1.  On the **Data Factory-XX** dev workspace, select
...
3.  On the left navigation, select **Data Factory-XX**, as shown in the
    image below.
...
4.  Navigate and click
    on [**Data_Factory@lab.LabInstance.Id**](mailto:Data_Factory@lab.LabInstance.Id) 
...
10. Navigate and click
    on [**Data_Factory@lab.LabInstance.Id**](mailto:Data_Factory@lab.LabInstance.Id) Workspace
...
38. In the left-sided navigation menu, navigate and click on ***Data
    Factory-XX***, as shown in the below image
...
1.  Sign-in into the Fabric portal and navigate to dev workspace as
    **Data Factory-XX** to connect to Git. Select **Workspace
    settings**.
...
3.  On the **Microsoft Azure** window, enter your credentials.
...
5.  On the **Azure DevOps Home** page, select **View my Organization**
...
7.  On the **Azure DevOps** tab, click on the **Continue** button
...
9.  On the **Create a project to get started** tab, enter the Project
    name as +++**DataFactory+**++ and click on **+ Create project**
    button
...
1.  Sign in to Microsoft Fabric and navigate to the development
    workspace (*Data Factory-XX*) to connect to Git. Then, select
    *Workspace settings*.
...
3.  From the **Data Factory-XX** Workspaces page,
    select **View** **deployment pipeline**.

## Task 1: Deploy content from one workspace to another

1.  From the **Data Factory-XX** Workspaces page,
    select **View** **deployment pipeline**.
...
4.  For the **Development** stage:In the dropdown list, select **Data
    Factory_XX** for the workspace. Then select the **Assign** check
    mark.
